...
import (
	...
	"github.com/veverita7/pinpoint-operator/controllers"
...
func init() {
	...
	utilruntime.Must(pinpointv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "pinpoint-operator.veverita7.github.io",
